...
if __name__ == "__main__":
	...
	# Argument parser
	parser = argparse.ArgumentParser(description='Kali Mirror Script By Xzender automatically select the best kali mirror server and apply the configuration')
	...
	# Banner
	print("#")
	print("# Kali Mirror Script By Xzender Cage")
	print("# Automatically select the best Kali mirror and apply the configuration")
	print("# https://github.com/xzendercage/kalimirrorscript")
	print("# https://twitter.com/sawasavx")
	print("#\n")
	...
	for line in file.readlines():
		...
		elif re.search(r'^# Autogenerated script by Kali Mirror Script', line, re.I):
